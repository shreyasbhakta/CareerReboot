...
const CANON_STATUS = ["Evaluated", "Applied", "Follow-up", "Responded", "Interview", "Offer", "Hired", "Rejected", "Ghosted", "Discarded", "SKIP"];

const TAB_VALUES = [
  "INBOX", "ALL", "EVALUATED", "APPLIED", "FOLLOW-UP", "RESPONDED", "INTERVIEW", "OFFER", "HIRED", "REJECTED", "GHOSTED", "DISCARDED", "SKIP",
] as const;
