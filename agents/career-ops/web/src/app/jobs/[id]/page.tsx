...
export default function JobPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      {/* job.page is where this worker was launched from — the real "back", not a hardcoded page */}
      <Link href={job.page || "/"} className="inline-flex items-center gap-1.5 text-sm text-muted transition-colors hover:text-brand">
        <ArrowLeft className="size-4" /> Back
      </Link>
