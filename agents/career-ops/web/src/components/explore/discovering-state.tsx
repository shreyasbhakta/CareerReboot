...
export function DiscoveringState({ offers }: { offers: EnrichedOffer[] }) {
  ...
  return (
    <>
      ...
      <div className="co-disc">
        ...
        {phase !== "revealing" &&
          (offers.length > 0 ? (
            // Real matches, appearing as the scan actually finds them — not a
            // placeholder. The scan keeps running underneath; this list just
            // grows in place instead of staying hidden until the very end.
